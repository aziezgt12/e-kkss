            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2 class="pt-110 text-center" style="font-family: sans">Visi - Misi </h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title mt-50">
                        <h5 style="color:red">VISI Kerukunan Keluarga Sulawesi Selatan (KKSS)</h5>
                    </div> <!-- section title -->
                ...
                <div class="col-lg-12">
                    <div class="section-title mt-50">
                        <h5 style="color:red">MISI Kerukunan Keluarga Sulawesi Selatan (KKSS) </h5>
                    </div> <!-- section title -->
                    <div class="about-cont">
                        <p><?= $profile->misi ?></p>
                    </div>
