    ...
    <!--====== jquery js ======-->
    <script src="<?php echo ('assets/js/vendor/modernizr-3.6.0.min.js') ?>"></script>
    ...
    <!--====== Nice Select js ======-->
    <script src="<?php echo ('assets/js/map-script.js') ?>"></script>
    
    <!--====== Nice Number js ======-->
    <script src="<?php echo ('assets/js/jquery.nice-number.min.js') ?>"></script>
    
    <!--====== Count Down js ======-->
    <script src="<?php echo ('assets/js/jquery.countdown.min.js') ?>"></script>
    
    <!--====== Validator js ======-->
    <script src="<?php echo ('assets/js/validator.min.js') ?>"></script>
    
    <!--====== Ajax Contact js ======-->
    <script src="<?php echo ('assets/js/ajax-contact.js') ?>"></script>
