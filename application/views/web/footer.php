    ...
    <!--====== jquery js ======-->
    <script src="<?php echo ('js/vendor/modernizr-3.6.0.min.js') ?>"></script>
    <script src="<?php echo ('js/vendor/jquery-1.12.4.min.js') ?>"></script>
    ...
    <!--====== Nice Number js ======-->
    <script src="<?php echo ('js/jquery.nice-number.min.js') ?>"></script>
    
    <!--====== Count Down js ======-->
    <script src="<?php echo ('js/jquery.countdown.min.js') ?>"></script>
    
    <!--====== Validator js ======-->
    <script src="<?php echo ('js/validator.min.js') ?>"></script>
    
    <!--====== Ajax Contact js ======-->
    <script src="<?php echo ('js/ajax-contact.js') ?>"></script>
